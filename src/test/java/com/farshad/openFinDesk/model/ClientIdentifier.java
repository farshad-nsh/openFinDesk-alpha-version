...
public class ClientIdentifier extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public ClientIdentifier(CharSequence hostName, CharSequence ipAddress) {
  ...
  public void put(int field$, Object value$) {
    switch (field$) {
    case 0: hostName = (CharSequence)value$; break;
    case 1: ipAddress = (CharSequence)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ClientIdentifier>
    ...
    /**
      ...
      * @return This builder.
      */
    public ClientIdentifier.Builder setHostName(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ClientIdentifier.Builder setIpAddress(CharSequence value) {
    ...
    public ClientIdentifier build() {
      try {
        ...
        record.hostName = fieldSetFlags()[0] ? this.hostName : (CharSequence) defaultValue(fields()[0]);
        record.ipAddress = fieldSetFlags()[1] ? this.ipAddress : (CharSequence) defaultValue(fields()[1]);
        return record;
      } catch (Exception e) {
