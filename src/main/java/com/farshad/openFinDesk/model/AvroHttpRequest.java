...
public class AvroHttpRequest extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public model.Active active;
   ...
   */
  public AvroHttpRequest(java.lang.CharSequence eventType, java.lang.Long requestTime, ClientIdentifier clientIdentifier, java.util.List<java.lang.CharSequence> employeeNames, model.Active active) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: requestTime = (java.lang.Long)value$; break;
    ...
    case 4: active = (model.Active)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   * @param value the value to set.
   */
  public void setActive(model.Active value) {
    this.active = value;
  }
   ...
   */
  public static model.AvroHttpRequest.Builder newBuilder() {
    return new model.AvroHttpRequest.Builder();
  }
   ...
   * @return A new AvroHttpRequest RecordBuilder
   */
  public static model.AvroHttpRequest.Builder newBuilder(model.AvroHttpRequest.Builder other) {
    return new model.AvroHttpRequest.Builder(other);
  }
   ...
   * @return A new AvroHttpRequest RecordBuilder
   */
  public static model.AvroHttpRequest.Builder newBuilder(model.AvroHttpRequest other) {
    return new model.AvroHttpRequest.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroHttpRequest>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(model.AvroHttpRequest.Builder other) {
      super(other);
      ...
      if (other.hasClientIdentifierBuilder()) {
        this.clientIdentifierBuilder = model.ClientIdentifier.newBuilder(other.getClientIdentifierBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(model.AvroHttpRequest other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.eventType)) {
        this.eventType = data().deepCopy(fields()[0].schema(), other.eventType);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public model.AvroHttpRequest.Builder setEventType(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public model.AvroHttpRequest.Builder clearEventType() {
      eventType = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public model.AvroHttpRequest.Builder setRequestTime(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public model.AvroHttpRequest.Builder clearRequestTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public model.AvroHttpRequest.Builder setClientIdentifier(ClientIdentifier value) {
    ...
    public ClientIdentifier.Builder getClientIdentifierBuilder() {
      if (clientIdentifierBuilder == null) {
        if (hasClientIdentifier()) {
          setClientIdentifierBuilder(model.ClientIdentifier.newBuilder(clientIdentifier));
        } else {
          setClientIdentifierBuilder(model.ClientIdentifier.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public model.AvroHttpRequest.Builder setClientIdentifierBuilder(ClientIdentifier.Builder value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public model.AvroHttpRequest.Builder clearClientIdentifier() {
    ...
    /**
      ...
      * @return This builder.
      */
    public model.AvroHttpRequest.Builder setEmployeeNames(java.util.List<java.lang.CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public model.AvroHttpRequest.Builder clearEmployeeNames() {
      employeeNames = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public model.AvroHttpRequest.Builder setActive(model.Active value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public model.AvroHttpRequest.Builder clearActive() {
      active = null;
    ...
    public AvroHttpRequest build() {
      try {
        ...
        record.requestTime = fieldSetFlags()[1] ? this.requestTime : (java.lang.Long) defaultValue(fields()[1]);
        if (clientIdentifierBuilder != null) {
        ...
        record.active = fieldSetFlags()[4] ? this.active : (model.Active) defaultValue(fields()[4]);
        return record;
