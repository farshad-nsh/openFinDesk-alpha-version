...
public class ClientIdentifier extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -6411545463380515219L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ClientIdentifier\",\"namespace\":\"model\",\"fields\":[{\"name\":\"hostName\",\"type\":\"string\"},{\"name\":\"ipAddress\",\"type\":\"string\"}]}");
   ...
   */
  public static model.ClientIdentifier.Builder newBuilder() {
    return new model.ClientIdentifier.Builder();
  }
   ...
   * @return A new ClientIdentifier RecordBuilder
   */
  public static model.ClientIdentifier.Builder newBuilder(model.ClientIdentifier.Builder other) {
    return new model.ClientIdentifier.Builder(other);
  }
   ...
   * @return A new ClientIdentifier RecordBuilder
   */
  public static model.ClientIdentifier.Builder newBuilder(model.ClientIdentifier other) {
    return new model.ClientIdentifier.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ClientIdentifier>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(model.ClientIdentifier.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(model.ClientIdentifier other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.hostName)) {
        this.hostName = data().deepCopy(fields()[0].schema(), other.hostName);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public model.ClientIdentifier.Builder setHostName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public model.ClientIdentifier.Builder clearHostName() {
      hostName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public model.ClientIdentifier.Builder setIpAddress(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public model.ClientIdentifier.Builder clearIpAddress() {
      ipAddress = null;
